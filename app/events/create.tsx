...
export default function CreateEventScreen() {
    ...
    const pickImage = async () => {
        ...
        if (!permission.granted) {
            Alert.alert("Permissão necessária", "Ative o acesso à galeria para enviar imagens.");
            return;
        }
...
const styles = StyleSheet.create({
    ...
    uploadRow: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 16, flexWrap: "wrap" },
